            ...
            <form action="{{ route('barangkeluar.store') }}" method="POST" enctype="multipart/form-data" class="forms-sample">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control  @error('jumlah') is-invalid @enderror"
                        id="exampleInputEmail3" placeholder="Jumlah" name="jumlah"
                        style="color: #000; background-color: #f5f5f5;">
                    @error('jumlah')
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control  @error('tgl_keluar') is-invalid @enderror"
                        id="exampleInputPassword4" placeholder="Tanggal Keluar" name="tgl_keluar"
                        style="color: #000; background-color: #f5f5f5;">
                    @error('tgl_keluar')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control  @error('ket') is-invalid @enderror"
                        id="exampleInputPassword4" placeholder="Keterangan" name="ket"
                        style="color: #000; background-color: #f5f5f5;">
                    @error('ket')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
